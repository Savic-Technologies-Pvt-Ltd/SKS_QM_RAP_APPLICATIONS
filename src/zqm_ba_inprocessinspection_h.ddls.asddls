...
@EndUserText.label: 'Basic View for Inprocess Inspection Header'
...
define root view entity ZQM_BA_InprocessInspection_H
  as select from zqm_t_inpr_ins_h
  composition [0..*] of ZQM_BA_InprocessInspection_I as _Item
{
