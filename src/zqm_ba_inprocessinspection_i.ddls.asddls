...
define view entity ZQM_BA_InprocessInspection_I
  as select from    zqm_t_inpr_ins_i as Item
  ...
  association to parent ZQM_BA_InprocessInspection_H as _Header on $projection.Uniqueid = _Header.Uniqueid
{
