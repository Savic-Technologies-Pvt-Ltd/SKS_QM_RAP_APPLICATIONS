...
define root view entity ZC_SETUP_APP_HEAD  provider contract transactional_query as projection on ZR_SETUP_APP_HEAD
{
    key Cuuid,
    Inspectionlot,
    Lotcreate,
...
currentoperationno,
operationdetails,
inspector,      @Consumption.valueHelpDefinition: [{ entity:{ name: 'ZCDS_VH_01',element: 'Opeartion' } }]
...
zdate,
    ...
    LocalLastChangedOn,
    LocalLastChangedBy,
     _Item : redirected to composition child ZC_SETUP_APP_ITEM
